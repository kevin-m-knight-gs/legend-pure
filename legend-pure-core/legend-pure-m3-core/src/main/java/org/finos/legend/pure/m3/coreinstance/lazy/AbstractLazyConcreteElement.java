...
public abstract class AbstractLazyConcreteElement extends AbstractLazyPackageableElement
{
    ...
    protected abstract void initialize(InstanceData instanceData, ListIterable<? extends BackReference> backReferences, ReferenceIdResolver referenceIdResolver, IntFunction<CoreInstance> internalIdResolver, PrimitiveValueResolver primitiveValueResolver, ElementBuilder elementBuilder);
