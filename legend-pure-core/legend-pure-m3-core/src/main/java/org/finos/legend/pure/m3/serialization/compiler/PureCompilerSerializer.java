...
public class PureCompilerSerializer
{
    ...
    private PureCompilerSerializer(FileSerializer fileSerializer, ModuleMetadataGenerator moduleMetadataGenerator, ProcessorSupport processorSupport)
    {
        ...
        this.fileDeserializer = fileSerializer.getDeserializer();
    ...
    {
        ModuleMetadata initial = this.fileDeserializer.moduleMetadataExists(directory, moduleName) ?
                                 this.fileDeserializer.deserializeModuleMetadata(directory, moduleName) :
