...
public class DistributedBinaryMetadataManager
{
    ...
    {
        return fromMetadata(DistributedBinaryMetadata.loadAllMetadata(classLoader));
    }

    public static DistributedBinaryMetadataManager fromClassLoader(ClassLoader classLoader, String... metadataNames)
    {
        return fromMetadata(DistributedBinaryMetadata.loadMetadata(classLoader, metadataNames));
    }
