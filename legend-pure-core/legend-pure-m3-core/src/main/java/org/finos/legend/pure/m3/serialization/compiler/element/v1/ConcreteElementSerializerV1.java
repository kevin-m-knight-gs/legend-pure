...
public class ConcreteElementSerializerV1 implements ConcreteElementSerializerExtension
{
    ...
    @Override
    public void serialize(Writer writer, CoreInstance element, SerializationContext serializationContext)
    {
        new SerializerV1(element, serializationContext).serialize(writer);
    }

    @Override
    public DeserializedConcreteElement deserialize(Reader reader, SerializationContext serializationContext)
    {
        return new DeserializerV1(serializationContext).deserialize(reader);
    }
}
