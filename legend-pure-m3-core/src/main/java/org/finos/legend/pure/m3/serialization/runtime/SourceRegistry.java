...
public class SourceRegistry
{
    ...
    {
        return this.sourcesById.keysView().select(id -> sourceIdPattern.matcher(id).matches());
    }

    public RichIterable<String> findSourceIds(String fileName)
    {
        String lowerCaseFileName = fileName.toLowerCase();
        return this.sourcesById.keysView().select(id -> id.toLowerCase().contains(lowerCaseFileName));
    }
