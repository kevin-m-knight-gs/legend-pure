...
public class TestElementLoader extends AbstractReferenceTest
{
    ...
    public static void serialize() throws IOException
    {
        ...
        referenceIds = ReferenceIdProviders.builder().withProcessorSupport(processorSupport).withAvailableExtensions().build();
    ...
    {
        test.accept(ElementLoader.builder()
    ...
    private static class FakeElementBuilder implements ElementBuilder
    {
        ...
        @Override
        public org.finos.legend.pure.m3.coreinstance.meta.pure.metamodel.PackageableElement buildConcreteElement(ConcreteElementMetadata metadata, MetadataIndex index, ReferenceIdResolvers referenceIds, Supplier<? extends DeserializedConcreteElement> deserializer, Supplier<? extends BackReferenceProvider> backRefProviderDeserializer)
        {
    ...
    private interface ElementWrapper<M extends PackageableElementMetadata>
    {
        CoreInstance getInstance();
    }

    private static class VirtualPackageWrapper extends PackageCoreInstanceWrapper implements ElementWrapper<VirtualPackageMetadata>
    {
    ...
    private static class FakeConcreteElement extends PackageableElementCoreInstanceWrapper implements ElementWrapper<ConcreteElementMetadata>
    {
