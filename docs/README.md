...
| [Proposals](proposals/) | Design proposals under discussion — [Profile model enrichment](proposals/profile-model-enrichment.md) (applicability, occurrence limits, annotation and profile incompatibility) |
