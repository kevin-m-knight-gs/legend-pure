...
public class CompiledCompElementBuilder extends M3GeneratedLazyElementBuilder
{
    private static final Logger LOGGER = LoggerFactory.getLogger(CompiledCompElementBuilder.class);

    private CompiledCompElementBuilder(ClassLoader classLoader, ModelRepository repository)
    {
    ...
    public static CompiledCompElementBuilder newElementBuilder(ClassLoader classLoader, ModelRepository repository)
    {
        return new CompiledCompElementBuilder(classLoader, repository);
    }
}
