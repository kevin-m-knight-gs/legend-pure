...
public abstract class AbstractTestConcreteElementSerializerExtension extends AbstractReferenceTest
{
    ...
    public void testPlatformVsExtraRepos()
    {
        ...
        GraphTools.getTopLevelAndPackagedElements(platformRuntime.getProcessorSupport())
                ...
                .forEach(platformElement ->
                {
                    ...
                    DeserializedConcreteElement fullDeserialized = serializeAndDeserialize(path, fullElement);
                    DeserializedConcreteElement platformDeserialized = serializeAndDeserialize(path, platformElement, platformSerializer, platformDeserializer);
    ...
    private void testSerializeDeserialize(CoreInstance element)
    {
        ...
        DeserializedConcreteElement deserialized = serializeAndDeserialize(path, element);
    ...
    private DeserializedConcreteElement serializeAndDeserialize(String path, CoreInstance element)
    {
        return serializeAndDeserialize(path, element, this.serializer, this.deserializer);
    }
