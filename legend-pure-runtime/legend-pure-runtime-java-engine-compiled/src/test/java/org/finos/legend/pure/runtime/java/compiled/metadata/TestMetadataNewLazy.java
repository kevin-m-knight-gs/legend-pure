...
public class TestMetadataNewLazy extends AbstractReferenceTest
{
    @ClassRule
    ...
    {
        testMetadata(MetadataNewLazy.builder()
    ...
    private void testMetadata(MetadataNewLazy metadata)
    {
        ...
        GraphNodeIterable.fromModelRepository(repository)
                ...
                .forEach(instance ->
                {
                    ...
                    Assert.assertSame(id, loaded, metadata.getElement(id));
