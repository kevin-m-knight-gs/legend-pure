...
public class TestFileSerializer extends AbstractPureTestWithCoreCompiled
{
    ...
    public void testAllElementsInDirectory() throws IOException
    {
        ...
        ElementNotFoundException e = Assert.assertThrows(ElementNotFoundException.class, () -> fileSerializer.deserializeElement(directory, noSuchElementPath));
    ...
    public void testAllElementsInJar() throws IOException
    {
        ...
        try (URLClassLoader classLoader = new URLClassLoader(new URL[]{jarPath.toUri().toURL()}, null))
        {
            ...
            String noSuchElementPath = "no::such::Element";
            ElementNotFoundException e = Assert.assertThrows(ElementNotFoundException.class, () -> fileSerializer.deserializeElement(classLoader, noSuchElementPath));
            Assert.assertEquals(noSuchElementPath, e.getElementPath());
    ...
    public void testAllModulesInDirectory() throws IOException
    {
        ...
        ModuleMetadataNotFoundException e = Assert.assertThrows(ModuleMetadataNotFoundException.class, () -> fileSerializer.deserializeModuleMetadata(directory, noSuchModule));
    ...
    public void testAllModulesInJar() throws IOException
    {
        ...
        try (URLClassLoader classLoader = new URLClassLoader(new URL[]{jarPath.toUri().toURL()}, null))
        {
            ...
            String noSuchModule = "no_such_module";
            ModuleMetadataNotFoundException e = Assert.assertThrows(ModuleMetadataNotFoundException.class, () -> fileSerializer.deserializeModuleMetadata(classLoader, noSuchModule));
            Assert.assertEquals(noSuchModule, e.getModuleName());
