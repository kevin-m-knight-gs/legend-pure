...
public class TypeProcessor
{
    ...
    {
        return ClassProcessor.isPlatformClass(rawType) ? fullyQualifiedJavaInterfaceNameForType(rawType) : javaInterfaceNameForType(rawType);
    }

    public static String javaInterfaceNameForType(CoreInstance rawType)
    {
        return JavaPackageAndImportBuilder.buildInterfaceNameFromType(rawType);
    }
