...
public class TestStringIndexer
{
    ...
    {
        testStringIndexerHasVersions(StringIndexer.builder().withLoadedExtensions().build(), 0, 1, 2);
    }
    ...
    {
        testStringIndexerHasVersions(StringIndexer.defaultStringIndexer(), 0, 1, 2);
    }
