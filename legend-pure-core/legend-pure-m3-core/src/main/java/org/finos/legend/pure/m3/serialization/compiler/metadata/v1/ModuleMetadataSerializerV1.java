...
public class ModuleMetadataSerializerV1 implements ModuleMetadataSerializerExtension
{
    ...
    @Override
    public void serializeManifest(OutputStream stream, ModuleManifest manifest, StringIndexer stringIndexer, Function<? super ModuleManifest, ? extends Iterable<String>> stringCollector)
    {
        try (Writer writer = BinaryWriters.newBinaryWriter(stream, false))
        {
            Writer stringIndexedWriter = stringIndexer.writeStringIndex(writer, stringCollector.apply(manifest));
    ...
    @Override
    public void serializeSourceMetadata(OutputStream stream, ModuleSourceMetadata sourceMetadata, StringIndexer stringIndexer, Function<? super ModuleSourceMetadata, ? extends Iterable<String>> stringCollector)
    {
        try (Writer writer = BinaryWriters.newBinaryWriter(stream, false))
        {
            Writer stringIndexedWriter = stringIndexer.writeStringIndex(writer, stringCollector.apply(sourceMetadata));
    ...
    @Override
    public void serializeExternalReferenceMetadata(OutputStream stream, ModuleExternalReferenceMetadata externalReferenceMetadata, StringIndexer stringIndexer, Function<? super ModuleExternalReferenceMetadata, ? extends Iterable<String>> stringCollector)
    {
        try (Writer writer = BinaryWriters.newBinaryWriter(stream, false))
        {
            Writer stringIndexedWriter = stringIndexer.writeStringIndex(writer, stringCollector.apply(externalReferenceMetadata));
    ...
    @Override
    public void serializeBackReferenceMetadata(OutputStream stream, ElementBackReferenceMetadata backReferenceMetadata, StringIndexer stringIndexer, Function<? super ElementBackReferenceMetadata, ? extends Iterable<String>> stringCollector)
    {
        try (Writer writer = BinaryWriters.newBinaryWriter(stream, false))
        {
            Writer stringIndexedWriter = stringIndexer.writeStringIndex(writer, stringCollector.apply(backReferenceMetadata));
    ...
    @Override
    public void serializeFunctionNameMetadata(OutputStream stream, ModuleFunctionNameMetadata functionNameMetadata, StringIndexer stringIndexer, Function<? super ModuleFunctionNameMetadata, ? extends Iterable<String>> stringCollector)
    {
        try (Writer writer = BinaryWriters.newBinaryWriter(stream, false))
        {
            Writer stringIndexedWriter = stringIndexer.writeStringIndex(writer, stringCollector.apply(functionNameMetadata));
