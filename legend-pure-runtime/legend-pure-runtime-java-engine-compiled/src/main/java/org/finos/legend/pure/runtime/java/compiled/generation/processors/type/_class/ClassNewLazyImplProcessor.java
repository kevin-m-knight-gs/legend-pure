...
public class ClassNewLazyImplProcessor
{
    ...
    private static StringBuilder appendStandardMethods(StringBuilder builder, ListIterable<PropertyInfo> simpleProperties, Class<? extends AbstractLazyCoreInstance> superClass)
    {
        ...
        return appendAddKeyValue(builder, simpleProperties, isConcreteElementOrVirtualPackage);
    }
    ...
    {
        builder.append("    public ").append(className).append("(VirtualPackageMetadata metadata, MetadataIndex index, ElementBuilder elementBuilder, ReferenceIdResolvers referenceIds, Supplier<? extends BackReferenceProvider> backRefProviderDeserializer)\n");
        builder.append("    {\n");
        builder.append("        super(metadata, elementBuilder, referenceIds, backRefProviderDeserializer);\n");
        builder.append("        this._package = computePackage(metadata.getPath(), referenceIds);\n");
        builder.append("        this._children = computePackageChildren(metadata.getPath(), index, referenceIds);\n");
        builder.append("    }\n");
        return builder;
    ...
    private static StringBuilder appendGetValueForMetaPropertyToOne(StringBuilder builder, ListIterable<PropertyInfo> simpleProperties, boolean isConcreteElementOrVirtualPackage)
    {
        builder.append("    @Override\n")
    ...
    private static StringBuilder appendGetValueForMetaPropertyToMany(StringBuilder builder, ListIterable<PropertyInfo> simpleProperties, boolean isConcreteElementOrVirtualPackage)
    {
        builder.append("    @Override\n")
    ...
    private static StringBuilder appendGetValueByIDIndex(StringBuilder builder, ListIterable<PropertyInfo> simpleProperties, boolean isConcreteElementOrVirtualPackage)
    {
        builder.append("    @Override\n")
        ...
        switch (simpleProperties.size())
        {
            ...
            case 1:
            {
                ...
                else if (isConcreteElementOrVirtualPackage && M3Properties.name.equals(propertyInfo.name))
                {
                    builder.append("        if (\"").append(propertyInfo.name).append("\".equals(propertyName))\n");
                    builder.append("        {\n");
    ...
    private static StringBuilder appendGetValuesByIndex(StringBuilder builder, ListIterable<PropertyInfo> simpleProperties, boolean isConcreteElementOrVirtualPackage)
    {
        builder.append("    @Override\n")
    ...
    private static StringBuilder appendIsValueDefinedForKey(StringBuilder builder, ListIterable<PropertyInfo> simpleProperties, boolean isConcreteElementOrVirtualPackage)
    {
        builder.append("    @Override\n")
    ...
    private static StringBuilder appendRemoveValueForMetaPropertyToMany(StringBuilder builder, ListIterable<PropertyInfo> simpleProperties, boolean isConcreteElementOrVirtualPackage)
    {
        builder.append("    @Override\n")
        ...
        switch (simpleProperties.size())
        {
            ...
            case 1:
            {
                ...
                builder.append("        if (\"").append(propertyInfo.name).append("\".equals(keyName))\n");
                builder.append("        {\n");
                if (isConcreteElementOrVirtualPackage && (M3Properties.name.equals(propertyInfo.name) || M3Properties._package.equals(propertyInfo.name)))
                {
                    builder.append("            throw new UnsupportedOperationException(\"Cannot remove value for '").append(propertyInfo.name).append("'\");\n");
                }
                else
                {
                    if (isConcreteElementOrVirtualPackage && !propertyInfo.isPackageChildren())
                    {
                        builder.append("            initialize();\n");
                    }
    ...
    private static StringBuilder appendModifyValueForToManyMetaProperty(StringBuilder builder, ListIterable<PropertyInfo> simpleProperties, boolean isConcreteElementOrVirtualPackage)
    {
        builder.append("    @Override\n")
    ...
    private static StringBuilder appendSetKeyValues(StringBuilder builder, ListIterable<PropertyInfo> simpleProperties, boolean isConcreteElementOrVirtualPackage)
    {
        builder.append("    @Override\n")
    ...
    private static StringBuilder appendAddKeyValue(StringBuilder builder, ListIterable<PropertyInfo> simpleProperties, boolean isConcreteElementOrVirtualPackage)
    {
        builder.append("    @Override\n")
