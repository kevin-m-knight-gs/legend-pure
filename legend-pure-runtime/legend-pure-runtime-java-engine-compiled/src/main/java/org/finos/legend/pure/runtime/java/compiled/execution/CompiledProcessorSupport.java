...
public class CompiledProcessorSupport implements ProcessorSupport
{
    ...
    public CoreInstance getClassifier(CoreInstance instance)
    {
        ...
        {
            return (this.metadata instanceof MetadataNewLazy) ?
                   ((MetadataNewLazy) this.metadata).getElementByPath(((ValCoreInstance) instance).getType()) :
    ...
    public CoreInstance type_BottomType()
    {
        if (this.metadata instanceof MetadataNewLazy)
        {
            return ((MetadataNewLazy) this.metadata).getElementByPath(M3Paths.Nil);
        }
    ...
    public CoreInstance type_TopType()
    {
        if (this.metadata instanceof MetadataNewLazy)
        {
            return ((MetadataNewLazy) this.metadata).getElementByPath(M3Paths.Any);
        }
