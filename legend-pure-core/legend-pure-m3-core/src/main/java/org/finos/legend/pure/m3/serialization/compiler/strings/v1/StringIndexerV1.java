...
public class StringIndexerV1 implements StringIndexerExtension
{
    @Override
    public int version()
    {
    ...
    {
        return StringWriterV1.writeStringIndex(writer, strings);
    }

    @Override
    public StringReader readStringIndex(Reader reader)
    {
        return StringReaderV1.readStringIndex(reader);
    }
}
