...
{
    protected AbstractLazyVirtualPackage(ModelRepository repository, int internalSyntheticId, VirtualPackageMetadata metadata, ReferenceIdResolvers referenceIds)
    {
