...
public class CompiledElementBuilder implements ElementBuilder
{
    ...
    public CoreInstance buildComponentInstance(InstanceData instanceData, MetadataIndex index, ReferenceIdResolver referenceIdResolver, IntFunction<? extends CoreInstance> internalIdResolver)
    {
        ...
        try
        {
            ...
            IntFunction<CoreInstance> wrappedInternalIdResolver = id -> AnyStubHelper.fromStub(internalIdResolver.apply(id));
            return constructor.newInstance(instanceData, index, referenceIdResolver, wrappedInternalIdResolver, this.primitiveValueResolver, this);
        }
        catch (Exception e)
        {
