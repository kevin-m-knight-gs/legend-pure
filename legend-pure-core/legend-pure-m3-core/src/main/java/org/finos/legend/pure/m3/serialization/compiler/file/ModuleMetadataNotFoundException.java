...
public class ModuleMetadataNotFoundException extends NotFoundException
{
    ...
    {
        super(buildMessage(moduleName, detail), cause);
    ...
    {
        super(buildMessage(moduleName, detail));
        this.moduleName = moduleName;
    }
    ...
    private static String buildMessage(String moduleName, String detail)
    {
        ...
        builder.append(" metadata not found");
        if (detail != null)
        {
