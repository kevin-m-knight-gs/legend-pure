...
import org.finos.legend.pure.runtime.java.compiled.generation.processors.type._class.ClassNewLazyImplProcessor;
...
public class JavaPackageAndImportBuilder
{
    ...
    {
        return buildLazyVirtualPackageClassReference(new StringBuilder(CODE_GEN_PACKAGE_NAME.length() + M3Paths.Package.length() + ClassNewLazyImplProcessor.CLASS_VIRTUAL_PACKAGE_SUFFIX.length())).toString();
    }

    public static String buildLazyVirtualPackageClassName()
    {
        return buildLazyVirtualPackageClassName(new StringBuilder(M3Paths.Package.length() + ClassNewLazyImplProcessor.CLASS_VIRTUAL_PACKAGE_SUFFIX.length())).toString();
    }
    ...
    {
        return buildImplClassNameFromUserPath(appendable, elementPath, ClassNewLazyImplProcessor.CLASS_LAZY_CONCRETE_SUFFIX);
    }
    ...
    {
        return buildImplClassNameFromUserPath(appendable, elementPath, ClassNewLazyImplProcessor.CLASS_LAZY_COMPONENT_SUFFIX);
    }
    ...
    {
        return buildImplClassNameFromUserPath(appendable, M3Paths.Package, ClassNewLazyImplProcessor.CLASS_VIRTUAL_PACKAGE_SUFFIX);
    }
    ...
    {
        return buildImplClassNameFromType(appendable, type, ClassNewLazyImplProcessor.CLASS_LAZY_CONCRETE_SUFFIX, processorSupport);
    }
    ...
    {
        return buildImplClassNameFromType(appendable, type, ClassNewLazyImplProcessor.CLASS_LAZY_COMPONENT_SUFFIX, processorSupport);
    }
