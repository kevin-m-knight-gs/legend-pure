...
public class ElementBackReferenceMetadata
{
    ...
    private ElementBackReferenceMetadata(String path, ImmutableList<InstanceBackReferenceMetadata> instanceBackReferences)
    {
        this.path = path;
    ...
    public boolean equals(Object other)
    {
        ...
        return this.path.equals(that.path) && this.instanceBackReferences.equals(that.instanceBackReferences);
    }
    ...
    {
        builder.append("path='").append(this.path).append("' instanceBackRefs=[");
    ...
    public static class Builder
    {
        ...
        {
            return new ElementBackReferenceMetadata(Objects.requireNonNull(this.path, "path must be specified"), buildInstanceBackRefs());
        }
