...
public class ConsoleCompiled extends AbstractConsole
{
    ...
    public static <T extends Appendable> T print(T appendable, String space, Object content, int max)
    {
        append(SafeAppendable.wrap(appendable).append(space), content, max, o -> false);
        return appendable;
    }
    ...
    private static <T extends Appendable> T append(T appendable, Object content, int max, Predicate<Object> isExcluded)
    {
