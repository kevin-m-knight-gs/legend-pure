...
public class TestCompiledElementBuilder extends AbstractReferenceTest
{
    ...
    public static void serialize() throws IOException
    {
        ...
        MutableSet<String> allModules = GraphTools.getTopLevelAndPackagedElements(processorSupport).collect(ModuleHelper::getElementModule).select(Objects::nonNull, Sets.mutable.empty());
