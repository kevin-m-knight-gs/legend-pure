...
public class ExternalReference
{
    ...
    public String toString()
    {
        StringBuilder builder = new StringBuilder(getClass().getSimpleName())
                .append("{referenceId='").append(this.referenceId).append('\'');
        if (this.backReferences.notEmpty())
        {
            builder.append(", backRefs=[");
            SafeAppendable safeAppendable = SafeAppendable.wrap(builder);
            this.backReferences.forEach(br -> br.appendString(safeAppendable).append(", "));
