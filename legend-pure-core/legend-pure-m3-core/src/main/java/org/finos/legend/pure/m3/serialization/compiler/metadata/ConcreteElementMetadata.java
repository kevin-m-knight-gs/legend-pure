...
public class ConcreteElementMetadata extends PackageableElementMetadata
{
    ...
    private ConcreteElementMetadata(String path, String classifierPath, SourceInformation sourceInfo, int referenceIdVersion, ImmutableList<String> externalReferences)
    {
