...
public class CompiledElementBuilder implements ElementBuilder
{
    ...
    @Override
    public Package buildVirtualPackage(VirtualPackageMetadata metadata, MetadataIndex index, ListIterable<? extends BackReference> backReferences, ReferenceIdResolvers referenceIds)
    {
        ...
        try
        {
            ...
            return constructor.newInstance(metadata, index, backReferences, referenceIds, this);
        }
        catch (Exception e)
        {
    ...
    @Override
    public PackageableElement buildConcreteElement(ConcreteElementMetadata metadata, MetadataIndex index, ReferenceIdResolvers referenceIds, Supplier<? extends DeserializedConcreteElement> deserializer, Supplier<? extends BackReferenceProvider> backRefProviderDeserializer)
    {
        ...
        try
        {
            ...
            return constructor.newInstance(metadata, index, this, referenceIds, this.primitiveValueResolver, deserializer, backRefProviderDeserializer);
        }
        catch (Exception e)
        {
    ...
    public CoreInstance buildComponentInstance(InstanceData instanceData, ListIterable<? extends BackReference> backReferences, ReferenceIdResolver referenceIdResolver, IntFunction<? extends CoreInstance> internalIdResolver)
    {
        ...
        try
        {
            ...
            return constructor.newInstance(instanceData, backReferences, referenceIdResolver, internalIdResolver, this.primitiveValueResolver, this);
        }
        catch (Exception e)
        {
    ...
    private Constructor<? extends Package> getVirtualPackageConstructor()
    {
        try
        {
            ...
            return javaClass.getConstructor(VirtualPackageMetadata.class, MetadataIndex.class, ListIterable.class, ReferenceIdResolvers.class, ElementBuilder.class);
        }
        catch (Exception e)
        {
    ...
    private Constructor<? extends PackageableElement> getConcreteElementConstructor(String classifierPath)
    {
        try
        {
            ...
            return javaClass.getConstructor(ConcreteElementMetadata.class, MetadataIndex.class, ElementBuilder.class, ReferenceIdResolvers.class, PrimitiveValueResolver.class, Supplier.class, Supplier.class);
        }
        catch (Exception e)
        {
    ...
    {
        return javaClass.getConstructor(InstanceData.class, ListIterable.class, ReferenceIdResolver.class, IntFunction.class, PrimitiveValueResolver.class, ElementBuilder.class);
    }
