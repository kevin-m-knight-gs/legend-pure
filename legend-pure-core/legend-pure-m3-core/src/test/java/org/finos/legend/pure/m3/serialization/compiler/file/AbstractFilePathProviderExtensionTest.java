...
public abstract class AbstractFilePathProviderExtensionTest extends AbstractReferenceTest
{
    ...
    @Test
    public void testAllModulePaths()
    {
        MapIterable<String, Pattern> patternBySeparator = buildPatternMap(getExpectedModuleMetadataPrefixDirs(), getExpectedModuleMetadataFilenameExtension());
        runtime.getCodeStorage().getAllRepositories().forEach(module ->
        {
            String moduleName = module.getName();
            forEachFSSeparator(fsSeparator ->
            {
                String filePath = this.extension.getModuleMetadataFilePath(moduleName, fsSeparator);
    ...
    @Test
    public void testUnicodeInModuleNames()
    {
    ...
    @Test
    public void testVeryLongModuleNames()
    {
    ...
    protected abstract String getExpectedModuleMetadataFilenameExtension();
