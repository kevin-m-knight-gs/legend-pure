...
public class MetadataIndex
{
    ...
    public boolean hasReferenceTo(String owner, String reference)
    {
        return this.externalReferences.hasReferenceTo(owner, reference);
    }

    public boolean hasAnyReferenceTo(String reference)
    {
        return this.externalReferences.hasAnyReferenceTo(reference);
    }

    public RichIterable<String> getReferencingElements(String reference)
    {
        return this.externalReferences.getReferencingElements(reference);
    }

    public RichIterable<BackReference> getBackReferences(String reference)
    {
        return this.externalReferences.getBackReferences(reference);
    }
