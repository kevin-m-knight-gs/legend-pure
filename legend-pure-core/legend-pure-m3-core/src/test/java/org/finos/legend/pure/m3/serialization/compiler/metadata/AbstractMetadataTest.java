...
public abstract class AbstractMetadataTest
{
    ...
    protected static ExternalReference newExtRef(String referenceId, BackReference... backReferences)
    {
        return newExtRef(referenceId, Arrays.asList(backReferences));
    }

    protected static ExternalReference newExtRef(String referenceId, Iterable<? extends BackReference> backReferences)
    {
        ExternalReference.Builder builder = ExternalReference.builder().withReferenceId(referenceId);
        backReferences.forEach(builder::addBackReference);
