...
public class SimpleElementBuilder implements ElementBuilder
{
    ...
    public SimpleElementBuilder(ModelRepository repository)
    {
    ...
    {
        return new SimpleLazyVirtualPackage(this.repository, this.repository.nextId(), metadata, index, this, referenceIds, this.primitiveValueResolver, backRefProviderDeserializer);
    }
    ...
    {
        return new SimpleLazyConcreteElement(this.repository, this.repository.nextId(), metadata, index, this, referenceIds, this.primitiveValueResolver, deserializer, backRefProviderDeserializer);
    }
    ...
    {
        return new SimpleLazyComponentInstance(this.repository, this.repository.nextId(), instanceData, backReferences, referenceIdResolver, internalIdResolver, this.primitiveValueResolver, this);
    }
}
