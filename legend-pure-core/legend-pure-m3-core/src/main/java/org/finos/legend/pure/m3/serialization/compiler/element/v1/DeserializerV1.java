...
public class DeserializerV1 extends BaseV1
{
    ...
    DeserializedConcreteElement deserialize(Reader reader)
    {
        ...
        return new DeserializedConcreteElement()
        {
            @Override
            ...
            {
                return nodes[0].getClassifierReferenceId();
            }

            @Override
            public SourceInformation getSourceInformation()
            {
                return nodes[0].getSourceInformation();
            }

            @Override
            public Iterable<? extends PropertyValues> getPropertyValues()
            {
                return nodes[0].getPropertyValues();
            }
        };
    }
    ...
    private InternalNode deserializeNode(Reader reader, String sourceId, int internalIdWidth)
    {
        ...
        return new InternalNode(name, classifierId, sourceInfo, propertiesWithValues);
    }
    ...
    private PropertyWithValues readPropertyWithValues(Reader reader, int internalIdWidth)
    {
        ...
        return new PropertyWithValues(name, sourceType, values);
    }
    ...
    private static class InternalNode implements DeserializedElement
    {
    ...
    private static class PropertyWithValues implements PropertyValues
    {
        private final String name;
        private final String sourceType;
        private final ListIterable<ValueOrReference> values;

        private PropertyWithValues(String name, String sourceType, ListIterable<ValueOrReference> values)
        {
            this.name = name;
        ...
        {
            return _Package.convertM3PathToM4(this.sourceType).with(M3Properties.properties).with(this.name);
        }
