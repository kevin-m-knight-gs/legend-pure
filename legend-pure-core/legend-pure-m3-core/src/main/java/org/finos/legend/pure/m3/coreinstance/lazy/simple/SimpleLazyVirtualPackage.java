...
class SimpleLazyVirtualPackage extends AbstractLazyVirtualPackage implements CoreInstanceWithStandardPrinting
{
    ...
    protected SimpleLazyVirtualPackage(ModelRepository repository, int internalSyntheticId, VirtualPackageMetadata metadata, MetadataIndex index, ElementBuilder elementBuilder, ReferenceIdResolvers referenceIds, PrimitiveValueResolver primitiveValueResolver, Supplier<? extends BackReferenceProvider> backRefProviderDeserializer)
    {
        super(repository, internalSyntheticId, metadata, elementBuilder, referenceIds, backRefProviderDeserializer);
